...
```bash
python3 scripts/kanban_update.py reject JJC-xxx --comment "门下省封驳：[具体问题和修改建议]"
```
...
```bash
python3 scripts/kanban_update.py approve JJC-xxx --comment "门下省准奏：[意见]"
```
...
- 最多 5 轮封驳，第 5 轮强制准奏（系统自动强制，可附改进建议）
- 审议结论控制在 200 字以内
